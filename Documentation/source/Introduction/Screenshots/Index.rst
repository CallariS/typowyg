...
The first shot shows the configuration palette in the backend. The others a lot of the `Trumbowyg Editor <https://alex-d.github.io/Trumbowyg/>`_'s functionalities.

Check out a Typowyg live demo `here <https://waxcode.net/projects/sites/demo-typowyg>`_.
